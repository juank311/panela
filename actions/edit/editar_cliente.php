...
{   
    ...
    if ($classCustomers->update($id, $nombre, $telefono, $documento, $correo, $direccion)) 
    {   
        $mensaje = "Cliente <b><i>" . $nombre . "</i></b> editado exitosamente!!";
    ...
    <div class="row">
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nombre" id="" value="<?php echo $obj_cliente->nombre?>">               
            </div>
            <div class="mb-3">
                <label for="telefono" class="form-label">Telefono:</label>
                <input type="text" class="form-control" name="telefono" id="" value="<?php echo $obj_cliente->telefono?>">               
            </div>
            <div class="mb-3">
                <label for="documento" class="form-label">Documento de Identidad:</label>
                <input type="text" class="form-control" name="documento" id="" value="<?php echo $obj_cliente->documento?>">               
            </div>
            <div class="mb-3">
                <label for="correo" class="form-label">Correo Electronico:</label>
                <input type="text" class="form-control" name="correo" id="" value="<?php echo $obj_cliente->correo?>">               
            </div>
            <div class="mb-3">
                <label for="direccion" class="form-label">Direccion:</label>
                <input type="text" class="form-control" name="direccion" id="" value="<?php echo $obj_cliente->direccion?>">               
            </div>


            
            <br />
            <button type="submit" name="editarProducto" class="btn btn-primary w-100"><i class="bi bi-person-bounding-box"></i> Editar Producto</button>
            </form>
        </div>
    </div>
            </section>
