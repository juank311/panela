...
$obj_customer = $classCustomers->search();
        ...
        <div class="container">
            ...
            <section id="datos">
                ...
                <?php if (isset($_GET['mensaje'])) : ?>
                    ...
                    <?php endif ?>
                    <!-- end error -->
                <a href="actions/insert/insertar_cliente.php" class="btn btn-primary"><i class="bi bi-x-circle-fill"></i>Nuevo Cliente</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">Id</th>
                  ...
                  <?php foreach ($obj_customer as $row) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="actions/edit/editar_cliente.php?id=<?php echo $row->id;?>" class="btn btn-warning"><i class="bi bi-pencil-fill"></i>Editar</a>
                        <a href="actions/delete/borrar_cliente.php?id=<?php echo $row->id;?>" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Borrar</a>
                      </td>
