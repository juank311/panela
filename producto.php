        ...
        <div class="container">
            ...
            <section id="datos">
                ...
                <?php if (isset($_GET['mensaje'])) : ?>
                    ...
                    <?php endif ?>
                    <!-- end error -->
                <a href="actions/insert/insertar_producto.php" class="btn btn-primary"><i class="bi bi-x-circle-fill"></i> Agregar Producto</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">Id</th>
                    ...
                    <tbody>
                  <?php foreach ($obj_products as $row) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="actions/edit/editar_producto.php?id=<?php echo $row->id;?>" class="btn btn-warning"><i class="bi bi-pencil-fill"></i>Editar</a>
                        <a href="actions/delete/borrar_producto.php?id=<?php echo $row->id;?>" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Borrar</a>
                      </td>
